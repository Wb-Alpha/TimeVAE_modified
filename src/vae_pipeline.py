...
def run_vae_pipeline(dataset_name: str, vae_type: str):
    ...
    scaled_valid_data, valid_scaler = scale_data(valid_data)
    ...
    # save scaler
    save_scaler(scaler=train_scaler, dir_path=model_save_dir)
    # Save vae
    ...
    inverse_scaled_prior_samples = inverse_transform_data(prior_samples, train_scaler)
    save_data(
